...
test('calculates ecrecover for given signature', async (t) => {
    ...
    const signature =
        '0xb6483ed445dbd979650106011bc1c6e6ef255c84404df7729bdaf8bda1ae428b19c13e1447bc3fdf618b351c951d992ee236b462dc3e8f9a6fd8dc952aa18ebe1b'
...
test('returns hash of LinkingAccounts without domain', async (t) => {
    // ARRANGE =======================
    const expectedHash = '0x1c5301a107c19f266dfc0ea7727a368fb01a0fd1f61c433edc1d53ed6919d86c'
...
test('hashes EIP712 structure: LinkingAccounts', async (t) => {
    // ARRANGE =======================
    const expectedHash = '0x7a29024e0725d369f071f440d1865857bcdc40be1568de9e04f02f62030908d7'
